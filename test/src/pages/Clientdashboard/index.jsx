...
export default function ClientdashboardPage() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-white-A700 md:flex md:flex-wrap sm:flex sm:flex-wrap">
        <div className="flex items-start  md:flex md:w-[100vw] ">
          <div className="relative z-[1] mt-[18px] flex w-[17%] flex-col md:w-[100vw] md:w-[20%]  items-center gap-[23px] md:w-full md:p-5">
            <div className="sticky top-0 md:flex md:flex-wrap h-[39px] w-[74%] ">
              <Img
                src="images/img_frame.svg"
                alt="image"
                className="absolute bottom-0 left-[0.00px] top-0 my-auto h-[39px] md:ml-[-15em] w-[65%]"
              />
              <Text
                size="5xl"
                as="p"
            ...
            <div className="flex flex-col items-start self-stretch md:w-[20%]  ">
              <ClientDashboardNavigation
                hidebgcopyOne={true}
                prop=""
                className="flex items-center justify-center gap-5 self-stretch pr-6 md:ml-[3em] sm:pr-5 md:w-[20%] md:items-center md:ml-[20px] md:justify-content md:flex"
              />
              <div className="ml-[17px] mt-6 flex w-[86%] rounded-md bg-white-A700 p-2.5 md:ml-0 md:w-full ">
                <div className="ml-1.5 flex items-center gap-1 md:ml-0">
                  <div className="flex items-center md:w-[3vw]">
                    ...
                    <Img
                      ...
                      alt="image_one"
                      className=" ml-[-18px] h-[30px] w-[30px] md:h-[40px]  md:w-[40px]"
                    />
                  </div>
              ...
              <div className="ml-[42px] mt-[620px] flex items-center gap-[17px] md: gap-[17px] md:mt-[12px] md:ml-0 md:mt-[38em] md:h-[2em]  ">
                <Img src="images/img_contact_support.svg" alt="contactsupport" className="h-[20px] w-[20px] md:h-[30px]  md:w-[30px] md:ml-[-3px] " />
              ...
              <div className="ml-[41px] mt-[18px] flex items-center gap-[18px] md:mt-[12px] md:ml-0 ">
                <Img
                  src="images/img_vector_black_900_01_20x20.svg"
                  alt="vector_one"
                  className="h-[20px] w-[20px] self-start md:h-[30px]  md:w-[30px] md:ml-[-3px]"
                />
                <Text size="md" as="p" className="self-end tracking-[0.30px] md:w-[10vw]">
                  Report an issue
                </Text>
              </div>
              <div className="mt-[9px] flex flex-col self-stretch md:flex-row md:mr-[-5em] ">
                <ClientDashboardNavigation1 className="flex items-center p-[11px] md:w-[8vw] md:ml-[-15px] " />
                <div className="h-px w-[240px] bg-gray-300 md:w-[3vw] md:mt-10 md:mr-[-5em]  md:ml-[-3px] " />
                <ClientDashboardNavigation1 products="Settings" className="flex items-center p-[11px] md:mb-[3em] " />
              </div>
              <ClientDashboardNavigation1 products="Logout" className="flex items-end gap-4 p-[11px] md:ml-[-15px] " />
            </div>
          ...
          <div className="relative ml-[-1px] flex-1 bg-gray-100 pb-[69px] md:ml-0 md:self-stretch md:p-5 md:pb-5 md:w-[100vw] md:h-[100vh]  ">
            <div className="relative h-[1070px] bg-[url(/public/images/img_group_37.png)] bg-cover bg-no-repeat pb-[31px] md:h-[1070px] md:w-[100vw] sm:pb-5 ">
              <div className="absolute bottom-[9%] left-0 right-0 m-auto h-[845px] w-[98%]  md:left-0 md:absolute md:bottom-[9%] md:right-0 md:h-[845px]  md:w-[98%]">
                <div className="mb-56 ml-[7px] flex w-[91%] items-start md:ml-0 sm:flex-col">
                  ...
                  <div class="relative ml-[-129px] flex flex-1 bg-black-900_01 sm:ml-0 sm:self-stretch">
                    <div class="mb-2.5 mt-[154px] flex w-[42%] items-center justify-between gap-5 md:w-full md:p-5" id="clickableDiv">
                      <span class="self-end tracking-[-0.11px]">
                        Wing Chun
                      </span>
                      <div class="flex flex-col items-start">
                        <span class="tracking-[-0.11px]">
                          Research by
                        </span>
                        <span class="tracking-[-0.11px]">
                          20/2/2024
                ...
                <div className="absolute right-[0.00px] top-1/4 m-auto flex w-[42%] flex-col items-start">
                  <div className="flex items-start self-stretch sm:flex-col">
                    ...
                    <Img
                      ...
                      alt="vector_three"
                      className="relative ml-[-169px] h-[201px] flex-1 object-cover sm:ml-0 sm:w-full sm:self-stretch md:self-stretch md:w-full md:ml-0  md:h-[201px] md:flex-1 md:object-cover"
                    />
                  </div>
                ...
                <div className="absolute left-[0.00px] top-[10.43px] m-auto flex w-[50%] flex-col items-start ">
                  <div className="flex items-center gap-[26px] self-stretch sm:flex-col md:flex-col">
                    <Img
                    ...
                    <div className="mb-2.5 flex flex-1 justify-center self-end rounded-[14px] bg-white-A700 p-[11px] shadow-xs sm:self-stretch">
                      <div className="mb-7 flex w-[80%] gap-10 md:flex-row sm:flex-col">
                        <div className="flex flex-1 flex-col gap-1">
                          <Img src="images/img_lock.svg" alt="image" className="ml-[17px] h-[25px] w-[25px] md:ml-0 sm:ml-0" />
                          <div className="flex flex-col items-start gap-[7px]">
                            <Text as="p" className="ml-[25px] !text-gray-900_02 md:ml-0 sm:ml-0">
                              4
                            </Text>
                  ...
                  <div className="mt-4 flex gap-[19px] self-stretch md:self-stretch md:w-[70vw] sm:flex-col ">
                ...
                <div className="absolute bottom-[-0.43px] left-[2.00px] m-auto flex w-[49%] flex-col gap-10 md:relative md:flex md:flex-col md:mb-[-1100.43px] md:bottom-[-0.43px]">
                ...
                <div className="absolute bottom-[8%] right-[6%] m-auto flex w-[36%] flex-col md:flex-wrap md:w-full md:right-[6%] ">
                  <div className="flex items-center sm:flex-col">
                    ...
                    <div className="relative ml-[-172px] flex flex-1 flex-col gap-[39px] md:mb-[-200px] bg-black-900_01 sm:ml-0 sm:self-stretch   md:self-stretch">
              ...
              <div className="absolute left-0 right-0 top-[0.00px] m-auto flex w-full flex-col items-start md:flex md:flex-wrap gap-[29px]">
