...
export default function AdminDashboardOnePage() {
  return (
    <>
      ...
      <div className="w-full bg-gray-100 pr-[38px] sm:pr-5 md:flex md:flex-wrap sm:flex sm:flex-wrap ">
        <div className="flex items-start gap-[47px] md:flex-col sm:flex-col">
          <Sidebar
            width="281px !important"
            className="!sticky top-0 flex h-screen flex-col overflow-auto bg-gray-50 pb-40 md:hidden md:p-5 md:pb-5"
          >
            <div className="ml-[3px] h-[879px] self-stretch bg-gray-50 md:ml-0 sm:ml-0" />
            <Img
