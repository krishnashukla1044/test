                        ...
                        <div className="flex">
                          <div className="flex md:flex-col items-center w-[94%] md:w-full gap-[21px]">
                            <div className="flex md:flex-col w-[100%] md:w-full gap-[21px]">
                              ...
                              <div className="h-[92px] w-full -[101px] md:w-[200px]  md:ml-[65%] md:bg-transparent md:h-[50px] bg-white-A700 cursor-pointer relative rounded-[46px] hover:shadow-xs">
                                <div className="flex justify-center w-full h-max md:mt-[-40%] left-0 bottom-0 right-0 top-0 p-[31px] m-auto sm:p-5 bg-white-A700 absolute rounded-[46px]">
                                  <Img
                              ...
                              <div className="h-[92px] w-full md:w-[200px] md:ml-[45%]  md:h-auto bg-white-A700 cursor-pointer relative rounded-[46px] hover:shadow-xs">
                                <div className="flex justify-center w-full h-max left-0 md:mt-[-75%] bottom-0 right-0 top-0 p-[31px] m-auto sm:p-5 bg-white-A700 absolute rounded-[46px]">
                                  <Img
                  ...
                  <div className="justify-center gap-[52px] grid-cols-[repeat(auto-fill,_minmax(620px_,_1fr))] grid :w-[70%]">
                    ...
                    <div className="flex justify-center w-full p-[27px] sm:p-5 bg-gray-50_01 rounded-[30px]flex justify-center w-full p-[27px] sm:p-5 bg-gray-50_01 rounded-[30px] flex justify-center w-full p-5 bg-gray-50_01 rounded-lg">
                      <div className="flex md:flex-col justify-between items-center w-full gap-5 my-3">
                        <div className="w-[21%] md:w-full p-[35px] sm:ml-[0%] sm:w-[20%] md:ml-[-10%] sm:p-5 bg-purple-900 rounded-[23px] w-[21%] md:w-full p-[39px]  sm:ml-[0%] sm:p-5 bg-purple-900 rounded-[23px] md:w-1/5 md:w-[50%]  flex justify-center items-center p-5 bg-purple-900 rounded-md">
                          <Img
