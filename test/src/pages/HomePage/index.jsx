...
export default function HomePagePage() {
  return (
    <>
      ...
      <div >
        <Header />
        <div className="self-stretch md:flex  md:h-[auto] md:flex-wrap ui4s md:flex-wrap ">
          <div className="flex flex-col items-center overflow-auto md:overflow-hidden md:w-full">

            {/* <div className="flex flex-col items-center overflow-auto  md:w-[100%]"> */}
            ...
            <div className="flex flex-col self-stretch md:flex self-stretch md:h-[auto] md:flex-wrap items-center  mt-4 md:flex md:self-stretch md:items-center md:mt-4 md:flex-col">
              ...
              <div className="h-[1618px] md:flex md:flex-wrap md:gap-5 md:h-auto w-[93%] md:h-auto mt-[26px] relative">
                ...
                <div className="h-[468px] w-[46%] bottom-[0.00px] right-[0.00px] m-auto absolute">
                  <Img
                    ...
                    alt="image_thirteen"
                    className="h-[394px] top-[0.00px] right-0 left-0 m-auto absolute md:h-[394px] md:flex-wrap md:flex"
                  />
                ...
                <div className="w-full h-[2149px] z-[2]">
                  <div className="flex md:flex-col items-center">
                    ...
                    <div className="flex md:flex-wrap flex-col self-end w-[30%] md:w-full  md:h-[auto] md:flex md:flex-wrap items-center mb-[670px]  gap-5 md:p-5 z-[1]">
                      <div className="flex justify-center flex-1">
                        <div className="flex justify-between md:flex-col items-start w-full gap-5 p-4 bg-white-A700 shadow-xs rounded-[24px]">
